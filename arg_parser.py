...
def parse_arguments(*args):
    ...
    parser.add_argument('--data_path', default='/home/chandu/Pytorch-TextureGAN/training_articles_pretrain/', type=str,
                        help='path to the data directory, expect train_skg, train_img, val_skg, val_img')

    parser.add_argument('--save_dir', default='/home/chandu/Pytorch-TextureGAN/save_dir/', type=str,
